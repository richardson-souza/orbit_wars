...
def main():
    print("=" * 60)
    print("             ORBIT WARS ELITE SUBMISSION BUILDER")
    print("=" * 60)

    archive_name = "elite_submission.tar.gz"
    single_file_name = "elite_submission.py"
    ...
    with tarfile.open(archive_name, "w:gz") as tar:
        for file_path in files_to_include:
            if os.path.exists(file_path):
                # Add file as its base name or rename elite_main.py to main.py inside tar to match Kaggle expectations
                arcname = "main.py" if file_path == "elite_main.py" else file_path
